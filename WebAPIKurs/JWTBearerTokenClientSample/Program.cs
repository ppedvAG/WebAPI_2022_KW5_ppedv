...
using JWTBearerTokenClientSample.Models;
...
LoginCredentialsResponse tokenResult = await client.Login("KevinWinter", "Wert1234!");
...
public class JWTBearerTokenClient
{
    ...
    {
        string loginURL = "https://localhost:7036/api/Auth/Login";
    ...
    {
        string url = "https://localhost:7036/WeatherForecast/";
